...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Integer corP = R.color.cardview_dark_background;
    ...
    private String resultado1(Integer v1, Integer v2) {
        ...
        v1v2 = compara(v1, v2);
        switch (v1v2) {
            case 1: return "Parabéns! Você venceu seu oponente!";
            case -1: return "Que pena... Você perdeu :( ";
    ...
    private String resultado2(Integer v1, Integer v2, Integer v3) {
        ...
        switch (soma) {
            ...
            case 7: return "Você e o Oponente 1 foram vencedores.";
